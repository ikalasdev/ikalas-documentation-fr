...
let config = {
  ...
  headers: {
    ...
    apikey: "VOTRE-CLE_API_ICI", // Votre clé d'API (à remplacer par votre vraie clé)
...
- **Remplacez `"VOTRE-CLE_API_ICI"`** par votre vraie clé d'API obtenue sur le dashboard
